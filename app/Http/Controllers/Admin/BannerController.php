...
class BannerController extends Controller
{
    ...
    public function getAdd()
    {
        ...
        return View('admin.banner.add')->with('status', $status);
    }
    ...
    public function postAdd(BannerRequest $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            if (in_array($extension, $ext)) {
                ...
                Resizer::resizePic($pathMain . $fileName, $pathBig . $fileName, 1500, 600, $fileExt, True);
       ...
       // $input['status'] = 1;
        ...
        return Redirect::action('Admin\BannerController@getIndex')
    ...
    {
        $images = Banner::whereIn('id', $request->get('deleteId'))->pluck('image')->all();
        foreach ($images as $item) {
            File::delete('assets/uploads/banner/' . $item);
        }
