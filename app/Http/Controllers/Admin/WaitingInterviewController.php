...
use App\Http\Requests\WaitingInterviewRequest;
...
class WaitingInterviewController extends Controller
{
    public function getIndex(Request $request)
    {
        ...
        $query = User::query();
        $query->userWithStatus(2)
            ->where('date_interview', '>=', $current_day['start_date'])
        ...
        return View('admin.waiting-interview.index')
    ...
    public function getAdd()
    {
        ...
        return View('admin.waiting-interview.add')
            ->with('skills', $skills)
    ...
    public function postAdd(WaitingInterviewRequest $request)
    {
        ...
        return Redirect::action('Admin\WaitingInterviewController@getIndex')
    ...
    public function getEdit($id)
    {
        ...
        return View('admin.waiting-interview.edit')
    ...
    public function postEdit($user_id, WaitingInterviewRequest $request)
    {
        $rules = [
    ...
    public function postDelete(WaitingInterviewRequest $request)
    {
    ...
    public function getGrade($user_id)
    {
        ...
        return View('admin.waiting-interview.grade')
            ->with('user', $user)
    ...
    public function postGrade($user_id, Request $request)
    {
        ...
        return View('admin.waiting-interview.grade-print')
            ->with('score', $score)
            ->with('user', $user)
            ->with('grade_data', $grade_data);
    }
