...
class EmailSendController extends Controller
{
    public function getIndex(Request $request)
    {
        ...
        return View('admin.email-send.index')
            ->with('data', $data);
    }
    ...
    public function getAdd()
    {
        ...
        return view('admin.email-send.add')
    ...
    public function postAdd(EmailSendRequest $request)
    {
        $input = $request->all();
        $input['type'] = 'email';
        ...
        return Redirect::action('Admin\EmailSendController@getIndex')->with('success', 'آیتم جدید اضافه شد.');
    }

    public function postDelete(EmailSendRequest $request)
    {
        EmailSendUser::whereIn('email_send_id', $request->get('deleteId'))->delete();
        if (EmailSend::destroy($request->get('deleteId'))) {
            return Redirect::action('Admin\EmailSendController@getIndex')
