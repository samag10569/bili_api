...
@section('title','مطالب علمی - نظرات')
@section('part','مطالب علمی - نظرات')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\ScientificCommentsController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>{{str_limit(strip_tags($row->comment),40)}}</td>
                                <td>{{@$row->scientific->title }}</td>
                                ...
                                <td>{{@$row->publishedby->name}} {{@$row->publishedby->family }}</td>
                                <td>{{jdate('Y/m/d',$row->created_at->timestamp)}}</td>

                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\ScientificCommentsController@getEdit',$row->id)}}" data-toggle="tooltip"
