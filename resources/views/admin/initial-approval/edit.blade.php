	...
	<div class="row">
		<div class="col-md-12">
		  ...
		  <div class="box box-primary">
			...
			{!! Form::model($data,array('action' => array('Admin\InitialApprovalController@postEdit',$data->id),'role' => 'form','files' => 'true','id' => 'ejavan_form')) !!}
						...
						<div class="row">
							...
							<div class="col-md-2 ejavan_col">
								<a class="btn btn-danger btn-sm delete_content" id="delete_content{{$item->id}}"
								   style="cursor:pointer" onclick="deleteContent('{{URL::action('Admin\InitialApprovalController@getDeleteContent',$item->id)}}',{{$item->id}})" ><i
