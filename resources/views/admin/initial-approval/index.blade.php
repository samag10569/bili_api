...
@section('title','اعضا تایید شده اولیه')
@section('part','اعضا تایید شده اولیه')
@section('content')
	<div class="row">
		...
		<div class="col-xs-12">
		  <div class="box">
			<div class="box-header">
			  ...
			  {!! Form::open(array('action' => array('Admin\InitialApprovalController@postDelete'),'style'=>'float: left')) !!}
			  <div class="box-tools">
			  ...
			  <table class="table table-hover">
				...
				@foreach($data as $row)
					...
					<tr @if(!$row->info->interview_type_id) class="warning" @endif>
						...
						<td>
							<center>
								<a href="{{URL::action('Admin\InitialApprovalController@getEdit',[$row->id])}}" data-toggle="tooltip"
