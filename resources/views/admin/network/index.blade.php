			  ...
			  <table class="table table-hover">
				...
				@foreach($data as $row)
					...
					<tr>
						...
						<td>
							<center>
								<a href="{{URL::action('Admin\NetworkController@getFriend',[$row->id])}}" data-toggle="tooltip"
								   data-original-title="مشاهده اتصالات" class="btn btn-warning  btn-xs" id="edit{{$row->id}}"><i
											class="fa fa-list"></i> مشاهده اتصالات </a>
							</center>
						</td>
					</tr>
