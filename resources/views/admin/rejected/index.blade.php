...
@section('title','  مدیریت اعضای رایگان ')
@section('part','مدیریت اعضای رایگان ')
@section('content')
            ...
            <div class="box">
               <div class="box-header">
				  <h3 class="box-title"></h3>
					...
					@if(Auth::user()->hasPermission('rejected.delete'))
					  {!! Form::open(array('action' => array('Admin\RejectedController@postDelete'),'style'=>'float: left')) !!}
					@endif
				  <div class="box-tools">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
							...
							<tr @if($row->mobile == null) class="danger" @elseif($row->info->membership_type_id == 3 || $row->info->membership_type_id == 4) class="warning" @endif>
								<td>
									<center>
								...
								@if(Auth::user()->hasPermission('rejected.edit'))
                                    <center>
                                        <a href="{{URL::action('Admin\RejectedController@getEdit',$row->id)}}" data-toggle="tooltip"
