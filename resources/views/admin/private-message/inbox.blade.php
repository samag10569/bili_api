...
@section('title','پیام های خصوصی دریافتی')
@section('part','پیام های خصوصی دریافتی')
@section('content')
	<div class="row">
			...
			<div class="box-header">
			  ...
			  <div class="box-tools">
				<a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
				  ...
				  <a class="btn btn-success btn-xs" href="{{URL::action('Admin\PrivateMessagesController@getSend')}}" data-toggle="tooltip"
					 data-original-title="پیام جدید">
			  ...
			  <table class="table table-hover">
				...
				@foreach($data as $row)
					...
					<tr>
						...
						<td>
								<a href="{{URL::action('Admin\PrivateMessagesController@getReplay',[$row->id])}}" data-toggle="tooltip"
								   data-original-title="پاسخ" class="btn btn-warning  btn-xs" id="edit{{$row->id}}"><i
                    ...
                    <div class="widget-body">
                        <div id="registration-form">
							<div class="form-group">
								{!! Form::label('name','نام گیرنده',array('class'=>'col-lg-3 control-label')) !!}
								<div class="col-lg-3">
									{!! Form::text('name',null,array('class'=>'form-control','placeholder' => 'نام')) !!}
								</div>
								{!! Form::label('family','نام خانوادگی گیرنده',array('class'=>'col-lg-3 control-label')) !!}
								<div class="col-lg-3">
