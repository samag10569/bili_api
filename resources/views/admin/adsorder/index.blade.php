...
@section('title','لیست  سفارش تبلیغات')
@section('part','لیست  سفارش تبلیغات')
@section('content')
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\AdsOrderController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\AdsOrderController@getEdit',$row->id)}}"
                                           data-toggle="tooltip"
