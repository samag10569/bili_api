...
@section('title','لیست ایمیل های معرفی شده')
@section('part','لیست ایمیل های معرفی شده')
@section('content')
	<div class="row">
		...
		<div class="col-xs-12">
		  <div class="box">
			<div class="box-header">
			  ...
			  {!! Form::open(array('action' => array('Admin\ContactsListController@postDeleteError'),'style'=>'float: left')) !!}
			  <div class="box-tools">
				<a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
					<i class="fa fa-search"></i> جستجو
				</a>
				<a class="btn bg-olive btn-flat btn-xs" href="{{URL::action('Admin\ContactsListController@getEmail')}}" data-toggle="tooltip"
								   data-original-title="لیست ایمیل ها">
					<i class="fa fa-list"></i>&nbsp;&nbsp; ایمیل های ارسالی 
				</a>
				<a class="btn bg-success btn-flat btn-xs" href="{{URL::action('Admin\ContactsListController@getEmailTest')}}" data-toggle="tooltip"
								   data-original-title="لیست ایمیل ها">
					<i class="fa fa-envelope"></i>&nbsp;&nbsp; ارسال ایمیل تست 
				</a>
