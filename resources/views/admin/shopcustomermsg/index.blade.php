...
@section('title','پیام های تبادل شده فروشگاه  ')
@section('part','پیام های تبادل شده فروشگاه  ')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\ShopController@postCustomerMsgDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                            ...
                            @foreach($data as $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="{{URL::action('Admin\ShopController@getCustomerMsgEdit',$row->id)}}" data-toggle="tooltip"
