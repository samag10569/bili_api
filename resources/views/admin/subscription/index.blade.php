...
@section('title','باشگاه مشتریان فروشگاه ها')
@section('part','باشگاه مشتریان فروشگاه ها')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\ShopSubscriptionController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <div class="widget flat radius-bordered">
                        <div class="widget-body">
                            <div id="registration-form">
                                ...
                                <div class="form-group">
                                    {!! Form::label('name','عنوان',array('class'=>'col-lg-3 control-label')) !!}
                                    <div class="col-lg-9">
                                        {!! Form::text('name',null,array('class'=>'form-control','placeholder' => 'عنوان')) !!}
                                    </div>
