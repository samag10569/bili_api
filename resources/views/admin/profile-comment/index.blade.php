...
@section('title','نظرات پروفایل کاربران')
@section('part','نظرات پروفایل کاربران')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\ProfileCommentController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>{{$row->sender->name }} {{$row->sender->family }}</td>
                                <td>{{jdate('Y/m/d',$row->created_at->timestamp)}}</td>
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\ProfileCommentController@getEdit',$row->id)}}" data-toggle="tooltip"
                                           data-original-title="ویرایش " class="btn btn-warning  btn-xs">                                            ویرایش
