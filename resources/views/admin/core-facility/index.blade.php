...
@section('title','هسته تسهیل')
@section('part','هسته تسهیل')
@section('content')
	<div class="row">
		...
		<div class="col-xs-12">
		  <div class="box">
			<div class="box-header">
			  ...
			  {!! Form::open(array('action' => array('Admin\CoreFacilityController@postDelete'),'style'=>'float: left')) !!}
			  <div class="box-tools">
			...
			<div class="box-body table-responsive no-padding">
			  <table class="table table-hover">
				...
				@foreach($data as $row)
					...
					<tr @if(($row->date_interview + (30 * 86400)) <= time()) class="danger" @endif>
						<td>
							<center>
						...
						<td>
							<center>
								<a href="{{URL::action('Admin\CoreFacilityController@getEdit',[$row->id])}}" data-toggle="tooltip"
