	...
	<div class="row">
		<div class="col-md-12">
		  ...
		  <div class="box box-primary">
			...
			{!! Form::model($data,array('action' => array('Admin\CoreFacilityController@postEdit',$data->id),'role' => 'form','files' => 'true','id' => 'ejavan_form')) !!}
			  ...
			  <div class="box-body">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-4">
								<a class="btn btn-block bg-info btn-lg" href="{{URL::action('Admin\CoreFacilityController@getAllotment',$data->id)}}">مشاهده خدمات تخصیص داده شده </a>
							</div>
							<div class="col-md-4">
						...
						<div class="row">
							...
							<div class="col-md-2 ejavan_col">
								<a class="btn btn-danger btn-sm delete_content" id="delete_content{{$item->id}}"
								   style="cursor:pointer" onclick="deleteContent('{{URL::action('Admin\CoreFacilityController@getDeleteContent',$item->id)}}',{{$item->id}})" ><i
