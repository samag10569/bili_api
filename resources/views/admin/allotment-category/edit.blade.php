...
@section('title','ویرایش مجموعه خدمات')
@section('part','ویرایش مجموعه خدمات')
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                {!! Form::model($data,array('action' => array('Admin\AllotmentCategoryController@postEdit',$data->id),'role' => 'form','files' => 'true','id' => 'ejavan_form')) !!}
                @include('admin.allotment-category.form')
                {!! Form::close() !!}
            </div><!-- /.box -->
        </div>
    </div>
