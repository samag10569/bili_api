...
@section('title','مجموعه خدمات')
@section('part','مجموعه خدمات')
@section('content')
        ...
        <div class="col-xs-8">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\AllotmentCategoryController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                        <a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
                            <i class="fa fa-search"></i> جستجو
                        </a>

                        <a class="btn btn-success btn-xs" href="{{URL::action('Admin\AllotmentCategoryController@getAdd')}}" data-toggle="tooltip"
                    ...
                    <table class="table table-hover">
                            ...
                            @foreach($data as $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="{{URL::action('Admin\AllotmentCategoryController@getEdit',$row['id'])}}" data-toggle="tooltip"
            ...
            $(function () {
                $("#list ul").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        //	alert(order);
                        $.post("{!!URL::action('Admin\AllotmentCategoryController@postSort')!!} ", order, function (theResponse) {
