...
@section('title','اعضا روز جاری')
@section('part','اعضا روز جاری')
@section('content')
	<div class="row">
		...
		<div class="col-xs-12">
		  <div class="box">
			<div class="box-header">
			  ...
			  {{--{!! Form::open(array('action' => array('Admin\CurrentDayMemberController@postDelete'),'style'=>'float: left')) !!}--}}
			  <div class="box-tools">
			  ...
			  <table class="table table-hover">
				...
				@foreach($data as $row)
					...
					<tr @if($row->mobile == null) class="danger" @endif>
						...
						<td>
							<center>
								@if(Auth::user()->hasPermission('current-day-member.edit'))
									@if($row->status_id < 3)
										<a href="{{URL::action('Admin\CurrentDayMemberController@getEdit',[$row->id])}}" data-toggle="tooltip"
