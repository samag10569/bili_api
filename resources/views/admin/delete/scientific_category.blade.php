...
@section('title','مجموعه مطالب علمی حذف شده')
@section('part','مجموعه مطالب علمی حذف شده')
@section('content')
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\DeleteController@postScientificCategory'),'style'=>'float: left')) !!}
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\DeleteController@getCancelScientificCategory',$row->id)}}" data-toggle="tooltip"
