...
@section('title','اخبار حذف شده')
@section('part','اخبار حذف شده')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">لیست اخبار حذف شده</h3>
                    {!! Form::open(array('action' => array('Admin\DeleteController@postNews'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(file_exists(public_path('assets/uploads/news/medium/'.$row->image)))
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\DeleteController@getCancelNews',$row->id)}}" data-toggle="tooltip"
