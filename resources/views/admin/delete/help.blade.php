...
@section('title','راهنمایی های حذف شده')
@section('part','راهنمایی های حذف شده')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">لیست راهنمایی های حذف شده</h3>
                    {!! Form::open(array('action' => array('Admin\DeleteController@postHelp'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(isset($row))
                                        @if(file_exists(public_path('assets/uploads/help/medium/'.$row->image)))
                                ...
                                <td>
                                    <center>
                                        @if($row->status_profile==1)
                                            ...
                                            <br>
                                        @endif
                                        @if($row->status_grade==1)
                                            صفحه تعیین گرید علمی
                                            <br>
                                        @endif
                                        @if($row->status_service==1)
                                            صفحه خرید خدمات
                                            <br>
                                        @endif
                                        @if($row->status_project==1)
                                            صفحه تعیین پروژه موظفی
                                            <br>
                                        @endif
                                    </center>
                                </td>
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\DeleteController@getCancelHelp',$row->id)}}" data-toggle="tooltip"
