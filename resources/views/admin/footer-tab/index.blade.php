...
@section('title','  تب های فوتر ')
@section('part','تب های فوتر')
@section('content')
        ...
        <div class="col-xs-8">
            ...
            <div class="box">
                <div class="box box-primary">
                    <!-- form start -->
                    {!! Form::open(array('action' => array('Admin\FooterTabController@postAdd'), 'role' => 'form','id' => 'ejavan_form', 'files'=> true)) !!}
                    <div class="box-body">
                ...
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\FooterTabController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\FooterTabController@getEdit',$row->id)}}" data-toggle="tooltip"
            ...
            $(function () {
                $("#list ul").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        //	alert(order);
                        $.post("{!!URL::action('Admin\FooterTabController@postSort')!!} ", order, function (theResponse) {
