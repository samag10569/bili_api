		...
		<div class="col-xs-12">
		  <div class="box">
			<div class="box-header">
			  ...
			  {!! Form::open(array('action' => array('Admin\CoreScientificController@postDelete'),'style'=>'float: left')) !!}
			  <div class="box-tools">
				<a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
					<i class="fa fa-search"></i> جستجو
				</a>
				
				<a class="btn btn-success btn-xs" href="{{URL::action('Admin\CoreScientificController@getAdd')}}" data-toggle="tooltip"
			...
			<div class="box-body table-responsive no-padding">
			  <table class="table table-hover">
				...
				@foreach($data as $row)
					...
					<tr @if($row->member) class="info" @endif>
						<td>
							<center>
						...
						<td>
							<center>
								<a href="{{URL::action('Admin\CoreScientificController@getEdit',[$row->id])}}" data-toggle="tooltip"
