...
@section('title','  شاخه تحصیلی')
@section('part','شاخه تحصیلی')
@section('content')
        ...
        <div class="col-xs-8">
            ...
            <div class="box">
                <div class="box box-primary">
                    <!-- form start -->
                    {!! Form::open(array('action' => array('Admin\CategoryController@postAdd'), 'role' => 'form','id' => 'ejavan_form', 'files'=> true)) !!}
                    <div class="box-body">
                ...
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\CategoryController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                            ...
                            @foreach($data as $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="{{URL::action('Admin\CategoryController@getEdit',$row->id)}}" data-toggle="tooltip"
