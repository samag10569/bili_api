        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">لیست درخواست های ارسال شده به هسته علمی</h3>
                    {!! Form::open(array('action' => array('Admin\MessageCoreController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>{{$row->title}}</td>
                                <td>
                                    @if(file_exists(public_path('assets/uploads/core-message/'.$row->file)) and $row->file != '' and $row->file != null)
										<a href="{!! asset('assets/uploads/core-message/'.$row->file) !!}" target="_blank">
											دانلود فایل 
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\MessageCoreController@getView',$row->id)}}" data-toggle="tooltip"
                                           data-original-title="مشاهده " class="btn btn-warning  btn-xs">
                                            مشاهده
                                            <i class="fa fa-edit"></i> </a>

                                        <a href="{{URL::action('Admin\MessageCoreController@getClose',$row->id)}}" data-toggle="tooltip"
