...
@section('title','صفحه ایستا')
@section('part','بصفحه ایستا')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">لیست صفحه ایستا</h3>
                    {!! Form::open(array('action' => array('Admin\PageController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                        <a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
                            <i class="fa fa-search"></i> جستجو
                        </a>

                        <a class="btn btn-success btn-xs" href="{{URL::action('Admin\PageController@getAdd')}}" data-toggle="tooltip"
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(file_exists('assets/uploads/page/medium/'.$row->image))
                                        <img src="{!! asset('assets/uploads/page/medium/'.$row->image) !!}"
                                             class="img-rounded"
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\PageController@getEdit',$row->id)}}" data-toggle="tooltip"
