...
@section('title','مدیریت گزارش های پیام های خصوصی')
@section('part','مدیریت گزارش های پیام های خصوصی')
@section('content')
	<div class="row">
		...
		<div class="col-xs-12">
		  <div class="box">
			<div class="box-header">
			  ...
			  {!! Form::open(array('action' => array('Admin\PrivateMessagesReportsController@postDelete'),'style'=>'float: left')) !!}
			  <div class="box-tools">
			...
			<div class="box-body table-responsive no-padding">
			  <table class="table table-hover">
				<tr>
					...
					<th>فرستنده</th>
					<th>کدشناسه کاربری</th>
					<th>ارسال کننده پیام</th>
					<th>متن گزارش شده</th>
					<th>تاریخ</th>
					<th>عملیات</th>
				</tr>
				@foreach($data as $row)
					...
					<tr>
						...
						<td>
							@if($row->msg->sender)
							{{$row->msg->sender->name.' '.$row->msg->sender->family}}
							@endif
						</td>
						<td>{{$row->message}}</td>
						<td>
						...
						<td>
								<a href="{{URL::action('Admin\PrivateMessagesController@getEdit',[$row->pm_id])}}" data-toggle="tooltip"
