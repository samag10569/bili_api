...
@section('title','  تب های هدر ')
@section('part','تب های هدر')
@section('content')
        ...
        <div class="col-xs-8">
            ...
            <div class="box">
                <div class="box box-primary">
                    <!-- form start -->
                    {!! Form::open(array('action' => array('Admin\TabController@postAdd'), 'role' => 'form','id' => 'ejavan_form', 'files'=> true)) !!}
                    <div class="box-body">
                ...
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\TabController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\TabController@getEdit',$row->id)}}" data-toggle="tooltip"
            ...
            $(function () {
                $("#list ul").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        //	alert(order);
                        $.post("{!!URL::action('Admin\TabController@postSort')!!} ", order, function (theResponse) {
