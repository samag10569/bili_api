        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">لیست لوگوها</h3>
                    {!! Form::open(array('action' => array('Admin\LogoController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                        <a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
                            <i class="fa fa-search"></i> جستجو
                        </a>

                        <a class="btn btn-success btn-xs" href="{{URL::action('Admin\LogoController@getAdd')}}" data-toggle="tooltip"
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(file_exists('assets/uploads/logo/medium/'.$row->image))
                                        <img src="{!! asset('assets/uploads/logo/medium/'.$row->image) !!}"
                                             class="img-rounded"
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\LogoController@getEdit',$row->id)}}" data-toggle="tooltip"
