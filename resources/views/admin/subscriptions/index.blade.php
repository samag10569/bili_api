...
@section('title','مدیریت اعضای باشگاه مشتریان ')
@section('part','مدیریت اعضای باشگاه مشتریان ')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\ShopController@postSubscriptionDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                        <a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
                            <i class="fa fa-search"></i> جستجو
                        </a>

                        <a class="btn btn-success btn-xs" href="{{URL::action('Admin\ShopController@getSubscriptionAdd')}}" data-toggle="tooltip"
                    ...
                    <table class="table table-hover">
                            ...
                            @foreach($data as $row)
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{URL::action('Admin\SearchMemberController@getEdit',$row->user_id)}}">{!! $row->user->name !!}</a></td>
                                    <td>{!! $row->user->id !!}</td>
                                    <td><a href="{{URL::action('Admin\ShopController@getEdit',$row->user_id)}}">{!! $row->shop->name !!}</a></td>
                                    ...
                                    <td>
                                        <center>
                                            <a href="{{URL::action('Admin\ShopController@getSubscriptionEdit',$row->id)}}" data-toggle="tooltip"
