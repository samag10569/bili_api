...
@section('title','مطالب علمی کاربران')
@section('part','مطالب علمی کاربران')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\ScientificController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                        <a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
                            <i class="fa fa-search"></i> جستجو
                        </a>

                        <a class="btn btn-success btn-xs" href="{{URL::action('Admin\ScientificController@getAdd')}}" data-toggle="tooltip"
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                               ...
                               <td>
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\ScientificUsersController@getEdit',$row->id)}}" data-toggle="tooltip"
