...
@section('title','ویرایش مجموعه سفارشات')
@section('part','ویرایش مجموعه سفارشات')
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                {!! Form::model($data,array('action' => array('Admin\AdsOrderCategoryController@postEdit',$data->id),'role' => 'form','files' => 'true','id' => 'ejavan_form')) !!}
                @include('admin.adsorder-category.form')
                {!! Form::close() !!}
            </div><!-- /.box -->
        </div>
    </div>
