...
@section('title','مجموعه سفارشات')
@section('part','مجموعه سفارشات')
@section('content')
        ...
        <div class="col-xs-8">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\AdsOrderCategoryController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                        <a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
                            <i class="fa fa-search"></i> جستجو
                        </a>

                        <a class="btn btn-success btn-xs" href="{{URL::action('Admin\AdsOrderCategoryController@getAdd')}}" data-toggle="tooltip"
                    ...
                    <table class="table table-hover">
                            ...
                            @foreach($data as $row)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <a href="{{URL::action('Admin\AdsOrderCategoryController@getEdit',$row['id'])}}" data-toggle="tooltip"
            ...
            $(function () {
                $("#list ul").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        //	alert(order);
                        $.post("{!!URL::action('Admin\AdsOrderCategoryController@postSort')!!} ", order, function (theResponse) {
