	...
	<div class="row">
		<div class="col-md-12">
		  ...
		  <div class="box box-primary">
			...
			{!! Form::model($data,array('action' => array('Admin\WaitingInterviewController@postEdit',$data->id),'role' => 'form','files' => 'true','id' => 'ejavan_form')) !!}
			  ...
			  <div class="box-body">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4">
								<a class="btn btn-block bg-info btn-lg" href="{{URL::action('Admin\WaitingInterviewController@getGrade',$data->id)}}">تعیین گرید علمی</a>
							</div>
							<div class="col-md-6">
								@if(!$grade)
									<a class="btn btn-block bg-danger btn-lg">گرید علمی فناور تعیین نشده است.</a>
								@else
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-5 ejavan_col">
								...
								<?php /*
								{!!Form::radio('member_status_id',3,$status_id_3,$active)!!}
						...
						<div class="row">
							...
							<div class="col-md-2 ejavan_col">
								<a class="btn btn-danger btn-sm delete_content" id="delete_content{{$item->id}}"
								   style="cursor:pointer" onclick="deleteContent('{{URL::action('Admin\WaitingInterviewController@getDeleteContent',$item->id)}}',{{$item->id}})" ><i
