...
@section('title','معرفی بال خدماتی')
@section('part','معرفی بال خدماتی')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">لیست معرفی بال خدماتی</h3>
                    {!! Form::open(array('action' => array('Admin\ServiceNetworkController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                        <a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
                            <i class="fa fa-search"></i> جستجو
                        </a>

                        <a class="btn btn-success btn-xs" href="{{URL::action('Admin\ServiceNetworkController@getAdd')}}" data-toggle="tooltip"
