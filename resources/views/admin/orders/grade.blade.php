...
@section('title','درخواست های مدرک معادل')
@if($temp)
	@section('part','درخواست های مدرک معادل تایید نشده')
@else
	@section('part','درخواست های مدرک معادل تایید شده')
@endif
@section('content')
	<div class="row">
		  ...
		  <div class="box">
			<div class="box-header">
			  ...
			  <div class="box-tools">
				...
				@if($temp)
					<a class="btn btn-success btn-xs" href="{{URL::action('Admin\OrdersController@getEquivalentPersian')}}" data-toggle="tooltip"
							   data-original-title="درخواست های تایید شده">
								<i class="fa fa-refresh"></i> تایید شده ها
								</a>
				@else
					
					<a class="btn btn-success btn-xs" href="{{URL::action('Admin\OrdersController@getEquivalentPersian',true)}}" data-toggle="tooltip"
							   data-original-title="درخواست های در انتظار تایید">
								<i class="fa fa-refresh"></i> در انتظار تایید
							</a>
				@endif
				...
				@foreach($data as $row)
					...
					<tr>
						...
						<td>
							<center>
							@if($temp)
								<a href="{{URL::action('Admin\GradeTempController@getEdit',[$row->id])}}" data-toggle="tooltip"
