...
@section('title','ارسال دعوت نامه')
@section('part','ارسال دعوت نامه')
	@section('content')
		<div class="row">
			<div class="col-md-12">
			  ...
			  <div class="box box-primary">
				...
				{!! Form::open(array('action' => array('Admin\EmailExcelController@postAdd'), 'role' => 'form','id' => 'ejavan_form','class' => 'form-horizontal', 'files'=> true)) !!}
				  @include('admin.email-excel.form')
				{!! Form::close() !!}
			  </div><!-- /.box -->
			</div>
		</div>
