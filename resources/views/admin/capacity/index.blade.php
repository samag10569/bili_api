...
@section('title','ظرفیت ثبت نام')
@section('part','ظرفیت ثبت نام')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box box-primary">
                    <!-- form start -->
                    {!! Form::open(array('action' => array('Admin\CapacityController@postAdd'), 'role' => 'form','id' => 'ejavan_form', 'files'=> true)) !!}
                    <div class="box-body">
                ...
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\CapacityController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                        <a href="{{URL::action('Admin\CapacityController@getEdit',$row->id)}}" data-toggle="tooltip"
                    ...
                    <div class="widget flat radius-bordered">
                        <div class="widget-body">
                            <div id="registration-form">
                                ...
                                <div class="form-group">
                                    {!! Form::label('capacity','ظرفیت کمتر از',array('class'=>'col-lg-3 control-label')) !!}
                                    <div class="col-lg-9">
                                        {!! Form::text('capacity',null,array('class'=>'form-control','placeholder' => 'ظرفیت کمتر از')) !!}
                                    </div>
