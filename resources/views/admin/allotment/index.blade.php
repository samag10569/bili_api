        ...
        <div class="col-xs-8">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\AllotmentController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                        <a href="#" data-toggle="modal" data-target="#search"  class="btn btn-info btn-xs">
                            <i class="fa fa-search"></i> جستجو
                        </a>

                        <a class="btn btn-success btn-xs" href="{{URL::action('Admin\AllotmentController@getAdd')}}" data-toggle="tooltip"
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                               ...
                               <td>
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\AllotmentController@getEdit',$row->id)}}" data-toggle="tooltip"
                ...
                <div id="container">
                    <div id="list">
                        <div class="alert alert-success alert-dismissable" style="direction: rtl; ">
                            ...
                            @else
                                <span style="font-size: 14px;">	لطفا برای مرتب سازی از منوی جستجو مجموعه مورد نظر را انتخاب کنید. </span>
                            @endif
                        </div>
