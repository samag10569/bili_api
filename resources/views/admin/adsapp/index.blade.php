...
@section('title','لیست تبلیغات نرم افزاری')
@section('part','لیست تبلیغات نرم افزاری')
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\AdsAppController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                        <a href="#" data-toggle="modal" data-target="#search" class="btn btn-info btn-xs">
                            <i class="fa fa-search"></i> جستجو
                        </a>

                        {{--<a class="btn btn-success btn-xs" href="{{URL::action('Admin\AdsAppController@getAdd')}}"
                           data-toggle="tooltip"
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            <tr>
                                ...
                                <td>
                                    @if(file_exists('assets/uploads/ads_app/medium/'.$row->image))
                                        <img src="{!! asset('assets/uploads/ads_app/medium/'.$row->image) !!}"
                                             class="img-rounded"
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\AdsAppController@getEdit',$row->id)}}"
                                           data-toggle="tooltip"
