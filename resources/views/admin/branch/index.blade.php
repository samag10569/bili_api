        ...
        <div class="col-xs-8">
            ...
            <div class="box">
                <div class="box box-primary">
                    <!-- form start -->
                    {!! Form::open(array('action' => array('Admin\BranchController@postAdd'), 'role' => 'form','id' => 'ejavan_form', 'files'=> true)) !!}
                    <div class="box-body">
                ...
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\BranchController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\BranchController@getEdit',$row->id)}}" data-toggle="tooltip"
            ...
            $(function () {
                $("#list ul").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        //	alert(order);
                        $.post("{!!URL::action('Admin\BranchController@postSort')!!} ", order, function (theResponse) {
