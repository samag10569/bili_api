        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Admin\VoucherController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                        <a href="#" data-toggle="modal" data-target="#search" class="btn btn-info btn-xs">
                            <i class="fa fa-search"></i> جستجو
                        </a>

                        <a class="btn btn-success btn-xs" href="{{URL::action('Admin\VoucherController@getAdd')}}"
                           data-toggle="tooltip"
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            <tr>
                                ...
                                <td>{{jdate('Y/m/d',$row->from_date)}}</td>
                                <td>{{jdate('Y/m/d',$row->to_date)}}</td>
                                <td>{{$row->price}} - {{$row->discount}}</td>

                                <td>
                                    <center>
                                        <a href="{{URL::action('Admin\VoucherController@getEdit',$row->id)}}"
                                           data-toggle="tooltip"
