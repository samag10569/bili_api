        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Out\MessageController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
...
{!! $row->file !!}
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Out\MessageController@getView',$row->id)}}" data-toggle="tooltip"
                                           data-original-title="مشاهده " class="btn btn-warning  btn-xs">
                                            مشاهده
                                            <i class="fa fa-edit"></i> </a>

                                        <a href="{{URL::action('Out\MessageController@getClose',$row->id)}}" data-toggle="tooltip"
