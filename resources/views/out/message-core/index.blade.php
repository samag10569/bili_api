        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    {!! Form::open(array('action' => array('Out\MessageCoreController@postDelete'),'style'=>'float: left')) !!}
                    <div class="box-tools">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="{{URL::action('Out\MessageCoreController@getView',$row->id)}}" data-toggle="tooltip"
                                           data-original-title="مشاهده " class="btn btn-warning  btn-xs">
                                            مشاهده
                                            <i class="fa fa-edit"></i> </a>

                                        <a href="{{URL::action('Out\MessageCoreController@getClose',$row->id)}}" data-toggle="tooltip"
