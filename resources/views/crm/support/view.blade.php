                            ...
                            <div class="post">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
										@if(file_exists(public_path('assets/uploads/support/'.$data->file)) and $data->file != '' and $data->file != null)
											<a href="{!! asset('assets/uploads/support/'.$data->file) !!}" target="_blank">
												دانلود فایل 
										...
										@if($data->status !=2)
											{!! Form::open(array('action' => array('Crm\SupportController@postView',$data->id),'role' => 'form','id' => 'ejavan_form')) !!}
