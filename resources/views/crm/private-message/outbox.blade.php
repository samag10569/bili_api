			...
			<div class="box mainbox" style="margin-bottom:20px;">
				...
				<div class="body">
					<ul>
						...
						<li class="default active"><a href="{{URL::action('Crm\PrivateMessagesController@getOutbox')}}">ارسال شده</a></li>
						  ...
						  <table class="table table-hover">
							...
							@foreach($data as $row)
								<tr @if(!$row->status) class="warning" @endif>
									...
									<td class='clickable-row' data-href="{{URL::action('Crm\PrivateMessagesController@getReplay',['from',$row->id])}}" style="cursor:pointer;"> 
										@if($row->receiver)
									...
									<td class='clickable-row' data-href="{{URL::action('Crm\PrivateMessagesController@getReplay',['from',$row->id])}}" style="cursor:pointer;">{{$row->subject}}</td>
									<td class='clickable-row' data-href="{{URL::action('Crm\PrivateMessagesController@getReplay',['from',$row->id])}}" style="cursor:pointer;">
