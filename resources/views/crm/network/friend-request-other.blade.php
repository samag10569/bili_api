				...
				<div class="row profile-network">
							...
							<div id="content2" class="content" style="display: block;">
								...
								@foreach($friends as $item)
									<div class="connect clearfix">
										...
										<a href="{{URL::action('Crm\NetworkController@getAcceptFriendRequest',$item->id)}}" class="link green link-hover"> قبول کردن </a>
					...
					<div class="col-md-3">
						<ul id="myaccordion" class="accordion">
							...
							<li class="nochild active" id="2"><a href="{{URL::action('Crm\NetworkController@getFriendRequestOther')}}">درخواست های دریافتی</a></li>
