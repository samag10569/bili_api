                            ...
                            @foreach($category as $row)
                                <li class="item-{{$row->id}} deeper parent">
                                    ...
                                    @php
                                        ...
                                        echo $multi->multiMenuSiide($row->id)
                                    @endphp
                                </li>
                            @endforeach
                ...
                @foreach($scientific as $row)
                    <div class="sid-post">
                        @if(file_exists('assets/uploads/scientific/medium/' . $row->image))
                            <img src="{!! asset('assets/uploads/scientific/medium/'.$row->image) !!}" class="pull-right"
                        ...
                        <a href="{{URL::action('Site\ScientificController@getDetails',[$row->id,Classes\Helper::seo($row->title)])}}"
